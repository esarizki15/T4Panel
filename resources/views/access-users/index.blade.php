                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('access-users.destroy', $user->id) }}" method="POST"
                                              style="display: inline"
                                              onsubmit="return confirm('Are you sure?');">
                                              <div class="btn-group">
                                                    <button type="button" class="btn btn-default btn-sm" onclick="window.location.href='{{ route('access-users.edit', $user->id) }}'"> <i class="fa fa-edit"></i></button>
