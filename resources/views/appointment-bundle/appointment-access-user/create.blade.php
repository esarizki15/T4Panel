...
<section class="content-header">
    <ol class="breadcrumb">
        ...
        <li class="">Users</li>
        <li class=""><a href="{{ route('access-users.index') }}">Appointment Users</a></li>
        <li class="active">Create Appointment User Access</li>
    </ol>
</section>
<div class="content">
    <div class="row justify-content-center">
        <div class="col-md-10" style="margin-top: 50px;">
            <div class="box">
                <div class="box-header with-border"><h3 class="box-title">{{ __('Create Appointment User Access') }}</h3></div>
                @if ($errors->count() > 0)
                <ul>
                ...
                @endif
                <div class="box-body">
                    <form method="POST" action="{{ route('appointment-access-user.store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-6">
