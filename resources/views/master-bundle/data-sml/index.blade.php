                                ...
                                <div class="col-md-12">
                                        <div class="custom-search-form row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                @endif
                                                <a class="btn btn-success  " href="{{ route(current(explode('.',Route::currentRouteName())) . '.index') }}?export=1&q={{$param['q']}}&dtr={{$param['dtr']}}&fbfl={{ isset($param['fbfl']) ? $param['fbfl'] : '' }}">
                    ...
                    <table class="table table-bordered ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-success btn-sm" onclick="window.location.href='{{ route(current(explode('.',Route::currentRouteName())). '.synch', $item->res_number ) }}'"> <i class="fa fa-refresh"></i></button> 
                                       ...
                                       @if( $grantType->DELETE ) 
                                            <form   action="{{ route(current(explode('.',Route::currentRouteName())) . '.destroy', $item->id) }}" method="POST"
