...
<div class="content">
    <div class="row justify-content-center">
        <div class="col-md-12" style="margin-top: 50px;">
            <div class="box">
                <div class="box-header with-border"><h3 class="box-title">{{ __('Update Profile Users') }}</h3></div>
 @if (session('message'))
                    ...
                    @method('PUT')
                     @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="email" type="email"  disabled  class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $users->email }}" required>
