...
class ServiceLocationController extends ScafoldController
{
    ...
    public function __construct(){
        ...
        $collection['client_type']= json_decode( json_encode([ ["id"=>"{$this->clientType}", "name"=> "{$this->clientTypelabel}" ] ]) );
            ...
            $service =  AppointmentServicesModel::select("id","service_name")->where("status",1)->where('client_type', '=', 'VISITOR')->get();
        $serviceRemap = [];
        ...
        $this->setCaption(\App\Http\Model\SubMenu::where("code","{$this->moduleName}-location")->first());
    }
    ...
    {   
        ...
        return $this->view('visitor-bundle.visitor-service-location.index',compact('items', "caption", "param", "columns" , "assetsPath" , "grantType", "dateRangeField" ) );
    }
       /**
    ...
    public function create()
    {
        ...
        return $this->view('visitor-bundle.visitor-service-location.create',compact('columns', "caption" ));
    }
    ...
    public function edit($id)
    {
        ...
        $columns = $columnArr;
        return  $this->view('visitor-bundle.visitor-service-location.edit',compact('model', "caption" ,'columns','assetsPath' ));
    }
