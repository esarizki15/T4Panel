...
class ResidentServiceServicesController extends ScafoldController
{
    public function __construct(){
        ...
        $this->setTypeOfField("service_image","file","image");
        $this->setTypeOfField("service_desc","textarea","description");
        ...
        $this->setTypeOfField("order","hidden");
        ...
        $this->setTypeOfField("member_id","hidden");
        ...
        $collection['client_type']= json_decode( json_encode([ ["id"=>"TREATMENT_SERVICE", "name"=> "TREATMENT SERVICE" ] ]) );
        $this->setCollections($collection);
           $this->setTypeOfField("service_image","file");
        ...
        $this->setCaption(\App\Http\Model\SubMenu::where("code","residentservice-services")->first());
    }
