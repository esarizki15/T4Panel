...
class ResidentServiceSubServicesController extends ScafoldController
{
    public function __construct(){
        ...
        $this->setCaption(\App\Http\Model\SubMenu::where("code","residentservice-sub-services")->first());
    }
}
