...
use App\Http\Model\BannerModel\BannerMarketPromo;
class BannerMarketPromoController extends ScafoldController
{
   
    public function __construct(){

        $model = new BannerMarketPromo;
        ...
        $this->setCaption(\App\Http\Model\SubMenu::where("code","banner-market-promo")->first());
    }
