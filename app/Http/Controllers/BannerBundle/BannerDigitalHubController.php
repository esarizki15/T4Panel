...
use App\Http\Model\BannerModel\BannerDigitalHub;
class BannerDigitalHubController extends ScafoldController
{
   
    public function __construct(){

        $model = new BannerDigitalHub;
        ...
        $this->setCaption(\App\Http\Model\SubMenu::where("code","banner-digital-hub")->first());
    }
