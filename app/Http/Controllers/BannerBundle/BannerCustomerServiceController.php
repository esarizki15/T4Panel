...
use App\Http\Model\BannerModel\BannerCustomerService;
class BannerCustomerServiceController extends ScafoldController
{
   
    public function __construct(){

        $model = new BannerCustomerService;
        ...
        $this->setCaption(\App\Http\Model\SubMenu::where("code","banner-customer-service")->first());
    }
