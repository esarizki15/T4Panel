...
use App\Http\Model\BannerModel\BannerPartnerDigitalHub;
class BannerPartnerDigitalHubController extends ScafoldController
{
   
    public function __construct(){

        $model = new BannerPartnerDigitalHub;
        ...
        $this->setCaption(\App\Http\Model\SubMenu::where("code","banner-partner-digital-hub")->first());
    }
